...
HD_PWD='C:/Users/Seacow/Desktop/lab1/lab1/lab1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log IFMTest.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source IFMTest.tcl
